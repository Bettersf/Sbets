...
export default function Header() {
  ...
  return (
    <>
      <div className="flex items-center justify-between w-full p-2.5 bg-black border-b-2 border-[#5ce1e6] rounded-t-2xl shadow-lg">
        ...
        <div className="flex gap-5 items-center">
          <Link href="/" passHref>
            <div className="h-9 m-0 cursor-pointer">
              <img alt="Gamba logo" src="/logos.png" className="h-full" />
            </div>
          </Link>
        </div>
