    ...
    <Modal onClose={() => onClose()}>
      <div className="mt-6 grid gap-2.5 pb-0 w-full">
        <div className="rounded-lg overflow-hidden">
          <div
            ref={ref}
            className="border-2 relative bg-gradient-to-br from-black-800 to-black-800 rounded-lg overflow-hidden shadow-3xl transform transition duration-500"
          >
            {shutterActive && (
            ...
            <div className="p-5 bg-black bg-opacity-40">
              ...
              <div className="mt-4 items-center justify-center flex">
                <img src="/logo.png" className="h-6 w-auto" alt="Sbets" />
              </div>
            </div>
          </div>
        </div>
